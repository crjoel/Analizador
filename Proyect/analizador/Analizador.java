...
public class Analizador {
    private AnalizadorLexico lex; // Analizador léxico para este analizador sintáctico
    private Token busca; // Marca de búsqueda por adelantado
    Ent sup = null; // Tabla de símbolos actual o superior
    int usado = 0; // Almacenamiento usado para las declaraciones

    public Analizador(AnalizadorLexico lexico) throws IOException {
        lex = lexico;
        mover();
    }
